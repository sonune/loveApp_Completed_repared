...
function createOfferer(peerUsername, receiver_channel_name) {
  ...
  //this works only when 2 devices on same network.
...
//Extra js
function Toggle(){
    Real = document.getElementById('navbar-real')
    Fake = document.getElementById('navbar-fake')
    if (Real.style.display = 'none'){
      Real.style.display = 'flex'
      Fake.style.display = 'none'

    }else if (Fake.style.display = 'none'){
